    ...
    <div className="min-h-screen flex flex-col bg-white text-gray-900">
      ...
      <style jsx global>{`
        ...
        @keyframes scale-in {
          ...
          60% { transform: scale(1.1) rotate(-45deg); opacity: 1; }
                      ...
                      <div className="w-full space-y-5 max-w-[220px] relative">
                        ...
                        <div className={`transition-all duration-500 ${animationStep === 1 ? 'opacity-100' : 'opacity-0 absolute inset-0 pointer-events-none'}`}>
                          ...
                          <div className="mb-8 text-center">
                            <div className="mb-3">
                              <span className="text-white text-xl font-bold tracking-wider block">REGISTER</span>
                              <p className="text-white/70 text-xs mt-1">Join thousands of satisfied customers</p>
                            </div>
                            <div className="w-20 h-1 bg-[#3777ff] mx-auto rounded-full"></div>
                          </div>
                          ...
                          <div className="space-y-6 px-2">
                            ...
                            <div className="space-y-3">
                              <label className="text-white/90 text-sm font-medium block flex items-center gap-2">
                                <svg className="w-4 h-4 text-[#3777ff]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                </svg>
                                Full Name
                              </label>
                              <div className="relative group">
                                <div className={`bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 transition-all duration-300 ${
                                  nameCompleted 
                                    ? 'border-[#3777ff] shadow-[0_0_20px_rgba(55,119,255,0.3)]' 
                                    : 'border-white/30 group-hover:border-[#3777ff]/50'
                                } relative overflow-hidden`}>
                                  {/* Animated background gradient */}
                                  <div className="absolute inset-0 bg-gradient-to-r from-[#3777ff]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                  <p className="text-white text-sm font-medium relative z-10">{nameValue || '|'}</p>
                                  {nameCompleted && (
                                    <div className="absolute right-3 top-1/2 transform -translate-y-1/2 transition-all duration-500 scale-0 animate-[scale-in_0.3s_ease-out_forwards]">
                                      <div className="bg-[#3777ff] rounded-full p-1">
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="relative group">
                                <div className={`bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 transition-all duration-300 ${
                                  ...
                                  {/* Animated background gradient */}
                                  <div className="absolute inset-0 bg-gradient-to-r from-[#3777ff]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                  <p className="text-white text-sm font-medium relative z-10 break-all">{emailValue || '|'}</p>
                                  {emailCompleted && (
                                    <div className="absolute right-3 top-1/2 transform -translate-y-1/2 transition-all duration-500 scale-0 animate-[scale-in_0.3s_ease-out_forwards]">
                                      <div className="bg-[#3777ff] rounded-full p-1">
                                        <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="relative group">
                                <div className={`bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 transition-all duration-300 ${
                                  ...
                                  {/* Animated background gradient */}
                                  <div className="absolute inset-0 bg-gradient-to-r from-[#3777ff]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                  <p className="text-white text-sm font-medium relative z-10">{phoneValue || '|'}</p>
                                  {phoneCompleted && (
                                    <div className="absolute right-3 top-1/2 transform -translate-y-1/2 transition-all duration-500 scale-0 animate-[scale-in_0.3s_ease-out_forwards]">
                                      <div className="bg-[#3777ff] rounded-full p-1">
                                        <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className={`transition-all duration-500 ${animationStep === 2 ? 'opacity-100' : 'opacity-0 absolute inset-0 pointer-events-none'}`}>
                          ...
                          <div className="mb-8 text-center">
                            <div className="mb-3">
                              <span className="text-white text-xl font-bold tracking-wider block">QUALIFY</span>
                              <p className="text-white/70 text-xs mt-1">Help us personalize your experience</p>
                            </div>
                            <div className="w-20 h-1 bg-[#3777ff] mx-auto rounded-full"></div>
                          </div>
                          
                          {/* Enhanced Form with same styling as register */}
                          <div className="space-y-6 px-2">
                            ...
                            {qualifyStep === 1 && (
                              <div className="space-y-3">
                                ...
                                <div className="space-y-3">
                                  <div className="relative group">
                                    <div className={`bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 transition-all duration-300 cursor-pointer ${
                                      ...
                                      {/* Animated background gradient */}
                                      <div className="absolute inset-0 bg-gradient-to-r from-[#3777ff]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                      <p className="text-white text-sm font-medium relative z-10">Owner / Executive</p>
                                      {selectedRole === 'Owner / Executive' && (
                                        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 transition-all duration-500 scale-0 animate-[scale-in_0.3s_ease-out_forwards]">
                                          <div className="bg-[#3777ff] rounded-full p-1">
                                            <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  ...
                                  <div className="relative group">
                                    <div className={`bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 transition-all duration-300 cursor-pointer ${
                                      ...
                                      {/* Animated background gradient */}
                                      <div className="absolute inset-0 bg-gradient-to-r from-[#3777ff]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                      <p className="text-white text-sm font-medium relative z-10">Manager / Director</p>
                                      {selectedRole === 'Manager / Director' && (
                                        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 transition-all duration-500 scale-0 animate-[scale-in_0.3s_ease-out_forwards]">
                                          <div className="bg-[#3777ff] rounded-full p-1">
                                            <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  ...
                                  <div className="relative group">
                                    <div className={`bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 transition-all duration-300 cursor-pointer ${
                                      ...
                                      {/* Animated background gradient */}
                                      <div className="absolute inset-0 bg-gradient-to-r from-[#3777ff]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                      <p className="text-white text-sm font-medium relative z-10">Staff / Student / Other</p>
                                      {selectedRole === 'Staff / Student / Other' && (
                                        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 transition-all duration-500 scale-0 animate-[scale-in_0.3s_ease-out_forwards]">
                                          <div className="bg-[#3777ff] rounded-full p-1">
                                            <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div className="space-y-3">
                                  <div className="relative group">
                                    <div className={`bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 transition-all duration-300 cursor-pointer ${
                                      ...
                                      {/* Animated background gradient */}
                                      <div className="absolute inset-0 bg-gradient-to-r from-[#3777ff]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                      <p className="text-white text-sm font-medium relative z-10">Actively looking now</p>
                                      {selectedTimeline === 'Actively looking now' && (
                                        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 transition-all duration-500 scale-0 animate-[scale-in_0.3s_ease-out_forwards]">
                                          <div className="bg-[#3777ff] rounded-full p-1">
                                            <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  ...
                                  <div className="relative group">
                                    <div className={`bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 transition-all duration-300 cursor-pointer ${
                                      ...
                                      {/* Animated background gradient */}
                                      <div className="absolute inset-0 bg-gradient-to-r from-[#3777ff]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                      <p className="text-white text-sm font-medium relative z-10">Within 6–12 months</p>
                                      {selectedTimeline === 'Within 6–12 months' && (
                                        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 transition-all duration-500 scale-0 animate-[scale-in_0.3s_ease-out_forwards]">
                                          <div className="bg-[#3777ff] rounded-full p-1">
                                            <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  ...
                                  <div className="relative group">
                                    <div className={`bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 transition-all duration-300 cursor-pointer ${
                                      ...
                                      {/* Animated background gradient */}
                                      <div className="absolute inset-0 bg-gradient-to-r from-[#3777ff]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                      <p className="text-white text-sm font-medium relative z-10">Just browsing</p>
                                      {selectedTimeline === 'Just browsing' && (
                                        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 transition-all duration-500 scale-0 animate-[scale-in_0.3s_ease-out_forwards]">
                                          <div className="bg-[#3777ff] rounded-full p-1">
                                            <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section id="learn-more" className="bg-white text-gray-900 py-16">
        ...
        <div className="max-w-7xl mx-auto mb-16 px-4">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center">
            {/* Clean Text Section - Takes 2 columns */}
            <div className="lg:col-span-2 order-2 lg:order-1">
              <h3 className="text-3xl font-bold text-gray-900 mb-6">See It In Action</h3>
              <p className="text-gray-600 text-lg mb-8">Watch how visitors become qualified leads in under 60 seconds.</p>
              
              {/* Simple Process */}
              <div className="space-y-3 mb-8">
                <div className="text-gray-700">→ Scan QR code</div>
                <div className="text-gray-700">→ Fill quick form</div>
                <div className="text-gray-700">→ Spin prize wheel</div>
                <div className="text-[#3777ff] font-medium">✓ Qualified lead delivered</div>
              </div>

              {/* Single Key Stat */}
              <div className="inline-block bg-blue-50 rounded-lg px-6 py-4">
                <div className="text-3xl font-bold text-[#3777ff] mb-1">3x</div>
                <div className="text-gray-600">More qualified leads</div>
              </div>
            </div>

            {/* Video Section - Takes 3 columns */}
            <div className="lg:col-span-3 order-1 lg:order-2 relative max-w-md mx-auto lg:mx-0">
                ...
                {isVideoMuted && (
                  ...
                  >
                    <span className="flex items-center gap-2 bg-black/60 px-4 py-2 rounded-full">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M3 10v4h4l5 5V5L7 10H3z"/></svg>
                      Tap to unmute
                    </span>
                  </button>
                )}
              ...
              {/* Single Social Float - Positioned more carefully */}
              <div className="hidden xl:block absolute -right-4 top-4 anim-float z-10">
                <div className="glass-card rounded-lg border border-white/50 shadow-lg w-[200px] p-3">
                  <div className="text-sm text-gray-700">🎉 "Just won a gift card!"</div>
                </div>
              </div>
            </div>
          </div>
