...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed w-full z-40 transition-all duration-300 ${scrolled ? 'bg-black shadow-md py-2' : 'bg-white py-4'}`} style={{ top: 0 }}>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className={`inline-flex items-center justify-center p-2 rounded-md ${scrolled ? 'text-white' : 'text-black'} hover:text-[#0bfe88]`}
            >
