    ...
    <div className={`${inter.className} bg-white text-black`}>
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16">
          ...
          <div className="w-full lg:w-2/5 lg:pr-8">
            ...
            <div className="space-y-4 mt-8">
              <div className="flex items-start">
                ...
                <p className="text-gray-700"><span className="font-semibold">Eliminate paper forms</span> - Go digital with our seamless registration system</p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <p className="text-gray-700"><span className="font-semibold">Instant lead capture</span> - Data syncs directly to your CRM in real-time</p>
              </div>
              ...
              <div className="flex items-start">
                ...
                <p className="text-gray-700"><span className="font-semibold">Boost engagement</span> - Interactive experiences increase conversion rates by 35%</p>
              </div>
            </div>
          ...
          <div className="w-full lg:w-3/5 flex flex-col md:flex-row items-center justify-center gap-6 lg:gap-4">
            {/* Tablet Device Mockup - Horizontal */}
            <div className="device-mockup tablet">
              <div className="rounded-[40px] border border-gray-700 shadow-[0_30px_60px_-30px_rgba(0,0,0,0.8)] bg-[#1a1a1a] p-2 w-[640px] max-w-full h-[380px] relative">
                {/* Tablet camera */}
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        <div>
                          ...
                          <div className="bg-gray-800 rounded-md p-4 mb-3 border border-gray-700">
                            ...
                            <p className="text-[var(--brand-blue)] text-sm font-bold mt-1">Booth #1234</p>
                          </div>
                        </div>
            ...
            <div className="device-mockup phone transform hover:-translate-y-2 transition-transform duration-500 ease-in-out camera-float">
              <div className="rounded-[54px] border border-gray-700 shadow-[0_30px_60px_-30px_rgba(0,0,0,0.8)] bg-[#1a1a1a] p-2 w-[280px] max-w-full h-[580px] relative">
                {/* Phone notch */}
