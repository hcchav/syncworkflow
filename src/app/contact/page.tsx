...
export const metadata = {
  title: 'Contact Us | SyncWorkflow',
  description: 'Get in touch with our growth team to accelerate your business.',
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-xl text-gray-500 max-w-2xl mx-auto">
            Ready to accelerate your growth? Our team of experts is here to help you scale your business.
          </p>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-1 text-gray-600">
                    <a href="mailto:hello@syncworkflow.com" className="hover:text-blue-600">
                      hello@syncworkflow.com
                    </a>
                  </p>
                </div>
              </div>
